---
title: "HTML Conversion to image formats"
type: docs
...
## HTML conversion to image

### Summary

This article demonstrates how to convert HTML file to one of image formats (JPEG, PNG, BMP, GIF, TIFF) by direct REST API calls or using SDKs.   
...
This example demonstrates how to convert HTML to JPEG using available SDKs. 
