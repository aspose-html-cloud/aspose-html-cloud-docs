function initAppHtmlConverter(id, args) {
    var uploadUrl = 'https://api.products.aspose.app/html/api/files';
    var convertUrl = 'https://api.products.aspose.app/html/api/conversion';
