function initAppFontConverter(id, args) {
    ...
    handlebars.registerHelper("inputFile", function(...args) {
        ...
        return data ? data.name : 'Montserrat-Regular.' + (inputParam.length>0 ? (inputParam.length>1 ? inputParam[1] :inputParam[0]).toLowerCase() : '');
    });
    ...
    function renderCodeBlock() {
        ...
        code = hljs.highlight(code, { language: 'cpp' }).value;
