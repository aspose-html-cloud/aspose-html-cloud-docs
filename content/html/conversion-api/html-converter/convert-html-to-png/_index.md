...
The example below demonstrates how to convert an HTML file from the local file system to PNG with explicitly specified options and save the result back to the local path.
